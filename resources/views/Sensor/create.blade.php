      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <form action="{{ url('sensor')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="nombre_t" placeholder="" name="status" required>
                <label for="floatingInput">status</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="nombre_t" placeholder="" name="cantidad" required>
